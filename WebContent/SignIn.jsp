...
<head>
  ...
  <link rel="stylesheet" href="/Sogong/css/style_signin.css">
		    ...
		    <article class="half">
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="/Sogong/op/signIn" method="post">
						                    <input type="text" name="loginid" id="loginid" class="inpt" required="required" placeholder="Your ID">
						                    <label for="text">Login ID</label>
						                    <input type="password" name="loginpw" id="loginpw" class="inpt" required="required" placeholder="Your Password">
